  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
      ...
      <header className="bg-transparent p-4 flex items-center justify-center z-50">
        <div className="flex items-center space-x-8 bg-white/90 backdrop-blur-sm rounded-full shadow-lg border border-white/50 p-2 px-6">
          <div className="flex items-center space-x-2">
            <img src="/assets/BIDORO-icon-img.jpg" alt="BIDORO logo" width="40" height="40" className="rounded-full" />
            <span className="text-2xl font-bold text-gray-900">BIDORO</span>
          </div>
          <button className="bg-green-700 text-white px-6 py-2 rounded-full font-medium hover:bg-green-800 transition-colors text-sm">
            Join waitlist
          </button>
        </div>
      </header>
      ...
      <footer className="bg-gray-800 text-white p-6 text-center">
        <div className="container mx-auto">
          <p>&copy; 2024 Bidoro. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="absolute right-0 bottom-0 top-[250px] w-[500px] md:w-[600px] -mr-32">
        ...
        <img src="/assets/Confetti Triangle.png" alt="Confetti triangle" className="absolute top-10 left-10 w-12 h-12 object-cover rounded-full shadow-lg rotate-30" />
        <img src="/assets/Confetti Dot.png" alt="Confetti dot" className="absolute top-1/2 left-24 w-12 h-12 object-cover rounded-full shadow-lg rotate-90" />
        <img src="/assets/Polygon 5.png" alt="Confetti polygon" className="absolute top-1/4 left-1/4 w-12 h-12 object-cover rounded-full shadow-lg -rotate-30" />
        <img src="/assets/Confetti Square.png" alt="Confetti square" className="absolute bottom-20 left-20 w-12 h-12 object-cover rounded-full shadow-lg -rotate-12" />

        <img src="/assets/Confetti Arch.png" alt="Confetti arch" className="absolute top-10 right-10 w-12 h-12 object-cover rounded-full shadow-lg rotate-12" />
        <img src="/assets/Confetti Ribbon.png" alt="Confetti ribbon" className="absolute top-20 right-20 w-12 h-12 object-cover rounded-full shadow-lg -rotate-45" />
        <img src="/assets/Confetti Circle.png" alt="Confetti circle" className="absolute top-[230px] right-[160px] w-12 h-12 object-cover rounded-full shadow-lg rotate-45 z-20" />
      </div>
    )
  }
    ...
    >
      ...
      <div className="container mx-auto px-6 py-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-5 grid-rows-2 gap-4 max-w-6xl mx-auto mb-16 h-80">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
            {/* AI Verification */}
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg text-center border border-gray-400">
...
/>
            ...
            <div className="max-w-xl mx-auto">
              ...
              <p className="text-gray-600 mb-8">
                <span className="text-lg md:text-xl">
                  ...
                  <span className="text-green-800 font-bold text-2xl md:text-3xl">
                    Bidoro
                  </span>
                </span>
                <br />
              ...
              <div className="space-y-4">
                <input
                  ...
                  className="w-full px-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all duration-200 text-gray-900 placeholder-gray-500"
                />
                <input
                  type="email"
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl"
                >
                  {loading ? (
        ...
        <div className="max-w-6xl mx-auto my-16 bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl p-8 border border-white/50 relative overflow-hidden">
          {/* Main content container uses flex-col to stack items */}
          <div className="flex flex-col relative z-10 w-full max-w-4xl mx-auto">
            {/* Text container, centered */}
            <div className="text-center p-4 mt-10">
              <h1 className="text-5xl md:text-6xl font-extrabold text-green-800 leading-none drop-shadow-lg">
                We are launching<br />Soon!
              </h1>
            </div>
            {/* Sand timer image container, now positioned with flexbox to flow below the text */}
            {/* Increased negative margin to push it further to the right */}
            <div className="w-[500px] md:w-[600px] self-end -mr-32">
              {/* The image now uses object-cover to eliminate white space and fills its container */}
              <img src="/assets/sandtimer.png" alt="Hourglass" className="w-full h-full object-cover" />
            </div>
          </div>

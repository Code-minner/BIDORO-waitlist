  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 md:py-16 px-4 relative">
      ...
      <div className="max-w-[1400px] mx-auto text-center relative">
        ...
        <motion.div 
          className="relative flex flex-col lg:flex-row items-center justify-between bg-white max-w-[1400px] my-24 md:h-[80vh] mx-auto rounded-[50px] shadow-xl border border-black overflow-hidden"
        ...
        >
          <motion.h2 
            className="text-5xl font-semibold text-[#1C341A] text-center mb-10"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.div 
            className="grid md:grid-cols-3 gap-10 max-w-[1400px] mx-auto"
            variants={staggerContainer}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
      ...
      >
        ...
        >
          ...
          {[
            ...
            <svg key="linkedin" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-gray-600 hover:text-green-700 transition-colors cursor-pointer" viewBox="0 0 24 24" fill="currentColor">
            ...
            <svg key="whatsapp" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-gray-600 hover:text-green-700 transition-colors cursor-pointer" viewBox="0 0 24 24" fill="currentColor">
            ...
            <svg key="instagram" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-gray-600 hover:text-green-700 transition-colors cursor-pointer" viewBox="0 0 24 24" fill="currentColor">
            ...
            <svg key="twitter" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-gray-600 hover:text-green-700 transition-colors cursor-pointer" viewBox="0 0 24 24" fill="currentColor">
            ...
            <svg key="tiktok" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-gray-600 hover:text-green-700 transition-colors cursor-pointer" viewBox="0 0 24 24" fill="currentColor">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <span className="text-[16px] md:text-[20px] text-gray-300">© All Rights Reserved. Bidoro, Inc</span>
        </motion.div>
      </motion.div>

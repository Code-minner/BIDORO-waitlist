      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        ...
        >
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6, ease: "easeOut" }}
          >
            <h3 className="text-lg font-semibold text-[#1C341A] mb-4">What's next?</h3>
            <div className="grid md:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-sm font-medium text-gray-800">Exclusive perks</p>
          ...
          >
            <p className="text-sm text-[#1C341A] font-medium">
              💡 <strong>Spread the word!</strong> Share Bidoro with friends and family who love smart shopping and sustainable commerce.
            </p>
          </motion.div>
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6, ease: "easeOut" }}
          >
            <p className="text-sm text-gray-600 mb-4">Stay connected for updates</p>
